...
class DiscoveredProgramTest {
    ...
    void testDiscoveredProgramGetters() {
        ...
        InstructionIr instruction = new InstructionIr(0, 0, "nop", List.of(), "I", InstructionIr.ControlFlowType.NORMAL,
                null, ".text", null);
        ...
        DiscoveredProgram program = new DiscoveredProgram(resolvedProgram, instructions, edges, regions,
