...
\textbf{1.2. Mục tiêu đề tài}

\textbf{1.2.1. Mục tiêu tổng quát}
...
\textbf{CHƯƠNG 2. CƠ SỞ LÝ THUYẾT VÀ CÔNG NGHỆ SỬ DỤNG}

\textbf{2.1. Cơ sở lý thuyết}

\textbf{2.1.1. Tổng quan về kiến trúc RISC-V và biến thể RV32I}
...
\textbf{2.1.2. Cấu trúc file ELF và ý nghĩa đối với disassembler}
...
\textbf{2.1.3. Phân tích công cụ tham khảo và phương pháp tiếp cận: GNU
objdump}
...
\textbf{2.1.4. Định dạng file ELF}
...
\textbf{2.1.5. Cơ sở kiểm thử trình disassembler}
